...
<br>
<div align="center">
<h2>  자료실 목록보기 (<a href="<%=path%>/psdBoard/form.jsp">자료등록</a> ) </h2>
 
<table border=1 width=700>
<tr align="center"> 
 <th > 번호 </th><th> 사진 </th> <th> 제목 </th> <th> 작성자 </th><th> 파일명 </th>
...
<tr align="center"> 
 ...
 <td align="left"> <a href="<%=path%>/getPsd.do?seq=${m.seq}" >
       &nbsp;<font color=#000000> ${m.title}</font>
      </a> 
 </td>
 <td>  ${m.writer} </td>
 <td>  ${m.updateFileStr} </td>
 <td>  ${m.regDate} </td>
