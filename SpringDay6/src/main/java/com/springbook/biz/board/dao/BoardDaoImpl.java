	...
	public List<BoardVo> getBoardList(String str1, String str2) {
		...
		*/
		...
		if (str1 == null || str2.equals("") ) {
			  ...
			  return  jdbcTemplate.query(GETBOARDTITLE_SQL, new BoardRowMapper(), "%" + str2 + "%");
		} else if(str1.equals("writer")) {
			  return  jdbcTemplate.query(GETBOARDWRITER_SQL, new BoardRowMapper(), "%" +str2 + "%");
		}
