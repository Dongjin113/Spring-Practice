...
public class BoardDaoImpl implements BoardDao {
	...
	String BOARD_COUNT="update board set cnt= cnt+1 where seq = ?";
	...
	public BoardVo getBoard(int seq) {
		...
		PreparedStatement pstmt_cnt= conn.prepareStatement(BOARD_COUNT);

		pstmt_cnt.setInt(1, seq);		
		pstmt_cnt.executeUpdate();
		}catch(Exception e) {
			e.printStackTrace();
		}finally {
