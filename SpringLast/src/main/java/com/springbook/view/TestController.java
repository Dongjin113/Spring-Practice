...
public class TestController {
	...
	@RequestMapping("apiEvinsert1.do")
	...
	public  String   apiEvinsert2() throws Exception {
	...
	@RequestMapping("apiEvinsert11.do")
	public  String  apiEvinsert11( CompanyVo  vo ) throws Exception {
       ...
       urlBuilder.append("&" + URLEncoder.encode("regId","UTF-8") + "=" + URLEncoder.encode("12A20000", "UTF-8")); 
       urlBuilder.append("&" + URLEncoder.encode("tmFc","UTF-8") + "=" + URLEncoder.encode("202209160600", "UTF-8")); /* (24시간 이내만 지원) */
       URL url = new URL(urlBuilder.toString());
       HttpURLConnection conn = (HttpURLConnection) url.openConnection();
       conn.setRequestMethod("GET");
       conn.setRequestProperty("Content-type", "application/json");
       ...
       System.out.println(sb);
        ...
        try {
           ...
           JSONObject Info = (JSONObject) item.get(0);
            ...
            //JSON name으로 추출
            System.out.println("Info: regId==>"+Info.get("regId"));
            System.out.println("Info: wf3Am==>"+Info.get("wf3Am"));
            System.out.println("Info: wf3Pm==>"+Info.get("wf3Pm"));
   ...
   @RequestMapping("apiEvinsert45.do")
   String apiExplorer45() throws Exception {
